...
from .whatsapp_utils import montar_mensagem_os, _mascarar_pii
...
class WhatsAppClickToChatService:
        ...
        try:
            if os.name == "nt":  # Windows
                try:
                    ...
                    logger.warning(
                        f"os.startfile falhou, tentando webbrowser.open: {e}"
                    )
    ...
    def enviar_whatsapp_click_to_chat(
        self,
        numero_pedido: str,
        solicitante: str,
        setor: str,
        ...
        try:
            ...
            return {
                ...
                "method": "click_to_chat",
                "link": link,
                "message": _mascarar_pii(
                    message
                ),  # Log a mensagem mascarada, não a original

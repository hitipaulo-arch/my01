...
def test_whatsapp_click_to_chat():
    ...
    emoji_map = {"Urgente": "🚨", "Alta": "⚠️", "Média": "📋", "Baixa": "📝"}
...
def test_field_truncation():
    ...
    print("  ✓ Info adicional truncada OK")
